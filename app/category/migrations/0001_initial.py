    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isoptovik', models.BooleanField(default=False, verbose_name='Оптовик?')),
                ('optovik_start_date', models.DateTimeField(blank=True, null=True, verbose_name='Дата начала работы оптовика')),
                ('optovik_end_date', models.DateTimeField(blank=True, null=True, verbose_name='Дата окончания оптовика')),
            ],
            options={
